...
For example, the above asm is located from ~$c000~ to ~$C008~ (49160 decimal). If you start the next asm block with ~{{!*~, it will POKE the bytes into location (49161 decimal)
